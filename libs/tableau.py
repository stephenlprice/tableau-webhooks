class TableauEnv:
  ...
  """
  def __init__(self, tableau_domain, site_name, rest_api_version):
    self.paths.classic = f"{tableau_domain}/api/{rest_api_version}"
  ...
  def __str__(self):
    return f"Tableau Site: {self.site_name}, ID: ({self.site_id}), at {self.tableau_domain}"
